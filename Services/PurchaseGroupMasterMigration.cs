...
{
    private readonly string _selectQuery = "SELECT PurchaseGroupId, ClientSAPId, PurchaseGroupCode, PurchaseGroupName FROM TBL_PurchaseGroupMaster";
    private readonly string _insertQuery = @"INSERT INTO purchase_group_master (purchase_group_id, company_id, purchase_group_code, purchase_group_name, created_by, created_date, modified_by, modified_date, is_deleted, deleted_by, deleted_date) 
    ...
    public List<object> GetMappings()
    {
        ...
        var logics = new List<string> { "Direct", "FK", "Direct", "Direct", "Default: 0", "Default: Now", "Default: null", "Default: null", "Default: false", "Default: null", "Default: null" };
